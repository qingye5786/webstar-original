...
$q = $db->select(PRE."user","where username='$username1' or email='$email1'");
...
if($error == false){
	...
	$query = $db->insert(PRE."user","username,password,email,time","'$username1','$password2','$email1','$addtime'");
	    if($query){
		    $_SESSION['name'] = $username1;
		    header("location:public/skip/skip_register_good.php");
	    }
}