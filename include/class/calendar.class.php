...
class Calendar{
	...
	function display(){
	 ...
	 private function changeDate($url=""){
		...
		echo "<tr class='top'>";
		echo "<td class='c'><a href='?".$this->preYear($this->year,$this->month)."'><img src=\"".PUB."static/img/101.gif\" /></a></td>";//上一年
		echo "<td class='c'><a href='?".$this->preMonth($this->year,$this->month)."'><img src=\"".PUB."static/img/53.gif\" /></a></td>";//上一月
		echo "<td colspan='3'>";
		echo "<form>";
		...
		echo "</form>";
		echo "</td>";
		echo "<td class='c'><a href='?".$this->nextMonth($this->year,$this->month)."'><img src=\"".PUB."static/img/54.gif\" /></a></td>";//下一年
		echo "<td class='c'><a href='?".$this->nextYear($this->year,$this->month)."'><img src=\"".PUB."static/img/102.gif\" /></a></td>";//下一月
		echo "</tr>";
		}
